module.exports = {
  docs: [
    ...
    },
    {
      ...
      label: 'Aleph Zero',
      collapsed: true,
      items: ['aleph_zero/project_structure', 'aleph_zero/single_contract_optimization','aleph_zero/installation','aleph_zero/entrypoints', 'aleph_zero/collections','aleph_zero/storage','aleph_zero/types', 'aleph_zero/invariant_errors']
    },
    'faq',
    'resources',
    {
