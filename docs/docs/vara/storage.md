...
| ------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| admin        | ActorId    | Account address of protocol admin. Admin is able to change fee, claim protocol fee or set the fee receiver, but cannot interfere with user positions or deposits and cannot close the pool. |
...
| Name     | Type      | Description                   |
| -------- | --------- | ----------------------------- |
| token_x  | ActorId   | address of x token.           |
| token_y  | ActorId   | address of y token.           |
...
| fee_receiver         | ActorId     | Address of entity enabling to claim protocol fee. By default it's admin but can be change for specific pool.                                    |
